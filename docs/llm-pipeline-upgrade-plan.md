...
### Stage 4 — 本机 Ollama 通路 — 已撤销（2026-08-16）

本机 `qwen2.5:7b` 跑在 100% CPU 上导致机器发烫/死机。Ollama 已卸载，代码不再提供本地模型通路。生成只走 DeepSeek。
...
- 已有 **32 期**（2026-05-25 → 2026-08-14），JSON + 配套 HTML 成对存放。本地曾落后 origin 22 期 digest，2026-08-16 rebase 后对齐。
